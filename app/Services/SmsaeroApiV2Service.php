...
class SmsaeroApiV2Service
{
    const URL_SMSAERO_API = 'https://gate.smsaero.ru/v2';
    private $email = ''; //Ваш логин|email
    private $api_key = 'Fh61PINt51NVk_sZOcHxSCOVj5ZOi3wf'; //Ваш api_key можно получить по адресу https://smsaero.ru/cabinet/settings/apikey/
    ...
    public function __construct($sign = false){
        $this->email = env('KEY_MAIL');
        $this->api_key = env('KEY_SMSAERO');
        if ($sign) {
            $this->sign = $sign;
        }
    }
     ...
     * @return array
     */
    public function viber_send($sign, $channel, $text, $number = null, $groupId = null,$imageSource = null, $textButton = null, $linkButton = null, $dateSend = null, $signSms = null, $channelSms = null, $textSms = null, $priceSms = null){
